...
namespace MiniBaccarat.SampleMerchant
{
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            if (m_ServerNode != null && !m_ServerNode.IsWorking())
            {
                ...
                if (m_ServerNode.IsWorking())
                {
                    ...
                    if (m_ServerNode.IsStandalone()) CommonLog.Info("Server is in standalone mode");
                    else CommonLog.Info("Internal URL: " + m_ServerNode.GetInternalAccessUrl());
