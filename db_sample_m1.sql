...
CREATE SCHEMA `db_sample_m1` DEFAULT CHARACTER SET utf8 ;

CREATE TABLE `db_sample_m1`.`tbl_bet_record` (
...
CREATE TABLE `db_sample_m1`.`tbl_player_balance` (
  `merchant_code` varchar(64) NOT NULL,
  `player_id` varchar(64) NOT NULL,
...
CREATE TABLE `db_sample_m1`.`tbl_trans_credit` (
...
CREATE TABLE `db_sample_m1`.`tbl_trans_debit` (
